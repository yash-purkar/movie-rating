...
export const movies: Movie[] =[
    ...
    },
    {
      ...
      summary: "When the menace known as The Joker emerges, Batman must face one of the greatest psychological tests of his ability to fight injustice.",
    ...
    },
    {
      ...
      summary: "A young hobbit, Frodo, who has found the One Ring, begins his journey to Mount Doom, where he can destroy it.",
